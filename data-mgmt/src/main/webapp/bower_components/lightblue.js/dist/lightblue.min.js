...
exports.resolve=function(){function e(e){return"string"!=typeof e?"":(e=e.replace(new RegExp("^/*"),""),e=e.replace(new RegExp("/*$"),""))}function n(e){return"undefined"!=typeof e&&""!==e}return 0===arguments.length?"":Array.prototype.slice.call(arguments,0).filter(n).map(e).join("/")},exports.isEmpty=function(e){return"undefined"==typeof e||""===e};
...
},{"./clientutil":1,"./rest":6}],5:[function(require,module,exports){
...
//# sourceMappingURL=lightblue.map.json